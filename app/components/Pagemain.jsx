  ...
  const send2 = async (e) => {
    ...
    setList((prevList) => [
      ...prevList,
      {
        type: "received",
        text:
          messages[1].payload.text == sent
            ? "Sorry, Information isn't present in the Knowledge base!"
                      ...
                      {e.text == "Visitors?" ? (
                        <div class="m-5 items-center mb-2 flex flex-col gap-2">
                          <div className="relative flex items-center justify-center">
                            ...
                            />
                            <div className="absolute bottom-0 justify-center rtl:translate-x-1/2 flex items-center text-sm text-white space-x-1 rtl:space-x-reverse">
                              <svg
