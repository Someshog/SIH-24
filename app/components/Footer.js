...
const Footer = () => {
  return (
    <footer className="footer bg-base-200 text-base-content p-10 flex justify-around  items-start">
      ...
      <form>
        <h6 className="footer-title text-2xl font-bold">Connect with us:</h6>
